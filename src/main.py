...
class SprintReaderMainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        # Note: pdf_viewer might not have note_created signal yet
    ...
    def init_menu_bar(self):
        ...
        # Check if pdf_viewer has export_notes method
        ...
        sprint_action.setShortcut(QKeySequence('Ctrl+Shift+S'))  # Changed to avoid conflict
        sprint_action.triggered.connect(lambda: self.start_specific_timer(TimerMode.SPRINT))
        timer_menu.addAction(sprint_action)
        
        # Notes Menu (if note features are available)
    ...
    def update_timer_display(self):
        ...
        try:
            ...
            # Don't spam console with timer update errors
            pass
...
{estimate.get("recommendation", "Keep reading!")}
        ...
        try:
            ...
            if ok and query.strip():
                ...
                if results:
                    ...
                    for note in results[:10]:  # Show first 10 results
    ...
    def on_timer_started(self, mode):
        ...
        print(f"📢 Timer started signal: {mode}")
        try:
    ...
    def on_timer_finished(self, mode):
        ...
        print(f"📢 Timer finished signal: {mode}")
    ...
    def on_break_started(self, duration):
        ...
        print(f"📢 Break started signal: {duration} seconds")
        minutes = duration // 60
        try:
            self.notification_manager.send_notification(
                "☕ Break Time!",
